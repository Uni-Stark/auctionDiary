...
public abstract class Hilt_FragmentAuctionDiary extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_FragmentAuctionDiary() {
    super();
  }

  Hilt_FragmentAuctionDiary(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FragmentAuctionDiary_GeneratedInjector) this.generatedComponent()).injectFragmentAuctionDiary(UnsafeCasts.<FragmentAuctionDiary>unsafeCast(this));
    }
  }
